...
# transformacja z json do pandas
# zmienic widok kolumn, tag (pierwiastki) a druga kolumna value
# walidacje value nie moze byc nullem, timestamp powinien byc w utc timezone
# klient do bigquery i wyslac w postaci tabeli
# autodetect=true
